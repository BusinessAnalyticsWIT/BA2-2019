# -*- coding: utf-8 -*-
"""
Created on Tue Mar 20 14:56:15 2018
...
#regression for association between major depression and Number of cigarettes smoked per month
...
#subset the data frame to only contain the variables of interest

subset2 = subset2[['NUMCIGMO_EST','TAB12MDX','MAJORDEPLIFE']].dropna()
